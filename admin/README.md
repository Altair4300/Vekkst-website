...
The built static files are served by `vite preview`. For a production-grade setup, consider serving the `dist/` directory with a dedicated static file server (e.g. Caddy or nginx).
