            ...
            {mode === "form" && (
              <form onSubmit={handleSubmit} className="p-6 space-y-5">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
                  <div><label className="block text-sm font-medium mb-1.5">Full Name *</label><input required type="text" value={form.name} onChange={e => setForm({...form, name: e.target.value})} className="w-full border rounded-lg px-4 py-2.5 text-base md:text-sm focus:outline-none focus:border-amber-400" placeholder="John Smith" /></div>
                  <div><label className="block text-sm font-medium mb-1.5">Email *</label><input required type="email" value={form.email} onChange={e => setForm({...form, email: e.target.value})} className="w-full border rounded-lg px-4 py-2.5 text-base md:text-sm focus:outline-none focus:border-amber-400" placeholder="you@company.com" /></div>
                  <div><label className="block text-sm font-medium mb-1.5">Company</label><input type="text" value={form.company} onChange={e => setForm({...form, company: e.target.value})} className="w-full border rounded-lg px-4 py-2.5 text-base md:text-sm focus:outline-none focus:border-amber-400" placeholder="Your brand" /></div>
                  <div><label className="block text-sm font-medium mb-1.5">Phone / WhatsApp</label><input type="tel" value={form.phone} onChange={e => setForm({...form, phone: e.target.value})} className="w-full border rounded-lg px-4 py-2.5 text-base md:text-sm focus:outline-none focus:border-amber-400" placeholder="+86 134 2474 5515" /></div>
                  <div><label className="block text-sm font-medium mb-1.5">Product Type</label>
                    <select value={form.productType} onChange={e => setForm({...form, productType: e.target.value})} className="w-full border rounded-lg px-4 py-2.5 text-base md:text-sm focus:outline-none focus:border-amber-400">
                  ...
                  <div><label className="block text-sm font-medium mb-1.5">Quantity</label><input type="text" value={form.quantity} onChange={e => setForm({...form, quantity: e.target.value})} className="w-full border rounded-lg px-4 py-2.5 text-base md:text-sm focus:outline-none focus:border-amber-400" placeholder="e.g. 500 pcs" /></div>
                  <div><label className="block text-sm font-medium mb-1.5">Fabric</label><input type="text" value={form.fabric} onChange={e => setForm({...form, fabric: e.target.value})} className="w-full border rounded-lg px-4 py-2.5 text-base md:text-sm focus:outline-none focus:border-amber-400" placeholder="e.g. 100% Cotton, 280gsm" /></div>
                  <div><label className="block text-sm font-medium mb-1.5">Size Range</label><input type="text" value={form.sizeRange} onChange={e => setForm({...form, sizeRange: e.target.value})} className="w-full border rounded-lg px-4 py-2.5 text-base md:text-sm focus:outline-none focus:border-amber-400" placeholder="e.g. XS-3XL" /></div>
                  <div className="md:col-span-2"><label className="block text-sm font-medium mb-1.5">Deadline</label><input type="date" value={form.deadline} onChange={e => setForm({...form, deadline: e.target.value})} className="w-full border rounded-lg px-4 py-2.5 text-base md:text-sm focus:outline-none focus:border-amber-400" /></div>
