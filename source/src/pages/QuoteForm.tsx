    ...
    return (
      <div className="min-h-screen bg-gray-50 py-12 md:py-16 px-4">
        <div className="max-w-lg mx-auto text-center">
          ...
          <h1 className="text-xl md:text-2xl font-bold text-gray-900 mb-3">Sign In Required</h1>
          <p className="text-gray-500 text-sm md:text-base mb-8">Please sign in or create an account to request a free quote. This helps us ensure you're a serious buyer and allows you to track your quote.</p>
          <div className="flex flex-col sm:flex-row gap-3 justify-center">
            <Link to={`/login?redirect=${encodeURIComponent("/quote")}`} className="btn-primary">Sign In</Link>
            <Link to={`/register?redirect=${encodeURIComponent("/quote")}`} className="btn-primary bg-white border-2 border-gray-200 text-gray-700 hover:bg-gray-50">Create Account</Link>
          </div>
    ...
    return (
      <div className="min-h-screen bg-gray-50 py-12 md:py-16 px-4">
        <div className="max-w-lg mx-auto text-center">
          ...
          <p className="text-gray-600 text-sm md:text-base mb-6">Your quote request has been received. Our team will respond within 24 hours.</p>
          ...
          <div className="flex flex-col sm:flex-row gap-3 justify-center">
            <Link to="/track-quote" className="btn-primary text-sm">Track Your Quote</Link>
            <Link to="/products" className="btn-primary bg-white border-2 border-gray-200 text-gray-700 hover:bg-gray-50 text-sm">Browse More Designs</Link>
          </div>
        </div>
      </div>
    );
      ...
      <div className="max-w-3xl mx-auto">
        ...
        <div className="bg-white rounded-xl shadow-sm border overflow-hidden">
          ...
          <div className="bg-[#0a0a0a] text-white p-4 md:p-6">
            <h1 className="text-xl md:text-2xl font-bold">Get a Free Quote</h1>
            ...
            <div className="p-4 md:p-8">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4 md:gap-6">
                ...
                >
                  ...
                  <span className="mt-4 text-amber-600 text-sm font-medium group-hover:underline">Get Started →</span>
                </button>
          ...
          {mode === "form" && (
            <form onSubmit={handleSubmit} className="p-4 md:p-6 space-y-5">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4 md:gap-5">
                ...
                <div>
                  <label className="block text-sm font-medium mb-1.5">Size Range</label>
                ...
                <div className="md:col-span-2">
                  <label className="block text-sm font-medium mb-1.5">Special Requirements</label>
              ...
              <button type="submit" disabled={submitQuote.isPending || uploading} className="w-full btn-primary text-sm justify-center py-4">
                {submitQuote.isPending || uploading ? <span className="flex items-center justify-center gap-2"><Loader2 className="w-5 h-5 animate-spin" /> Submitting...</span> : "Submit Quote Request"}
              </button>
