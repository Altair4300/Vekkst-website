          ...
          <div className="md:col-span-1">
            <div className="bg-white rounded-lg shadow-sm border p-6 space-y-6">
              <div className="text-center">
                <div className="w-20 h-20 bg-[#E60012] rounded-full flex items-center justify-center mx-auto mb-3">
              ...
              <div className="space-y-2">
                <Link to="/quote" className="flex items-center gap-3 p-3 bg-[#E60012] text-white rounded text-sm font-medium hover:bg-[#c4000f] transition-colors">
                  <FileText className="w-4 h-4" /> Request New Quote
                </Link>
                <Link to="/track-quote" className="flex items-center gap-3 p-3 bg-gray-50 rounded text-sm hover:bg-gray-100 transition-colors">
                  <FileText className="w-4 h-4 text-[#E60012]" /> Track a Quote
                </Link>
              </div>

              <Button onClick={logout} variant="outline" className="w-full text-red-600 hover:text-red-700 hover:bg-red-50">
  ...
  return (
    <div className="bg-white rounded-lg shadow-sm border">
      <div className="p-4 border-b">
        <h2 className="font-semibold flex items-center gap-2"><FileText className="w-5 h-5 text-[#E60012]" /> My Quote Requests</h2>
      </div>
