  ...
  return (
    <>
      ...
      <section className="relative w-full bg-black">
        ...
        <Link
          to="/products"
          className="absolute top-[26%] left-[3%] w-[19%] h-[13%] cursor-pointer z-10 border-2 border-red-500"
          aria-label="OEM / ODM Solutions"
        />
        {/* REQUEST A QUOTE button — right, dark */}
        <Link
          to={isAuthenticated ? "/quote" : "/register"}
          className="absolute top-[26%] left-[24%] w-[19%] h-[13%] cursor-pointer z-10 border-2 border-red-500"
      ...
      <section className="section !pb-0 bg-gray-50">
        <div className="container-site">
