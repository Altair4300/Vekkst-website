      ...
      <div className="max-w-7xl mx-auto px-4 py-14">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-10">
          ...
          <div className="md:col-span-1">
            <img src="/images/es-logo.png" alt="ES" className="h-10 w-auto mb-4 brightness-0 invert" />
          ...
          <div>
            ...
            <div className="mt-5 flex gap-4">
              <a href="https://www.instagram.com/vekkstgarment" target="_blank" rel="noopener noreferrer" className="text-gray-500 hover:text-amber-400 transition-colors">
              ...
              <a href="https://wa.me/8613125204154" target="_blank" rel="noopener noreferrer" className="text-gray-500 hover:text-green-500 transition-colors">
