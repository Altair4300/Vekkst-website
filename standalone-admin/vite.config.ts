...
export default defineConfig({
  ...
  resolve: {
    alias: {
      ...
      // These aliases point at the bundled backend type stubs in ./backend/.
      // They mirror the backend tsconfig so that the AppRouter type import
      // in src/providers/trpc.tsx resolves correctly at build time.
